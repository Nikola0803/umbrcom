...
// This is now the only source for this page. Wrapped directly in
// PageLayout since that (header + footer chrome) used to come from
// CmsPage — removing CmsPage also silently removed the header/footer.

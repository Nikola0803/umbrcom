          ...
          <div className="space-y-10">
            ...
            <div className="text-right space-y-6">
              {[
                ...
                <a key={item.label} href={item.href} target={item.href.startsWith("http") ? "_blank" : undefined} rel="nofollow noopener noreferrer" className="flex items-center justify-end gap-4 group cursor-pointer">
                  <div className="text-right">
